...
# weights_path = "/vepfs/gaowh/backup/trsl/1103backup/_12_hbsp_fusion_avgavg/resNet50_12_hbsp_fusion_avgavg_best.pth"
weights_path = "/root/work2023/deep-learning-for-image-processing-master/pytorch_classification/Test5_resnet_sl/1113_hbsp_fusion_avgavg/resNet501113_hbsp_fusion_avgavg_best.pth"
...
class CustomDataset_Multi(torch.utils.data.Dataset):
    def __init__(self, im_dir, hb_im_names, sp_im_names,im_labels, im_path,im_transforms=None):
        self.im_dir = im_dir
    ...
    def __getitem__(self, idx):
        ...
        # try:
        #     ydpath=os.path.join(self.im_dir,self.im_path_head[idx],'眼底照相', self.yd_im_name[idx].split(';')[0])
        ...
        return hbimages,spimages,self.im_labels[idx], self.im_path_head[idx]
...
def load_data_multi(label_path, train_lists, img_path,
    ...
    for train_list in train_lists:
        ...
        train_sets.append(CustomDataset_Multi(img_path, hb_im_names, sp_im_names,im_labels , im_path,im_transforms))
...
def runpredict(LISTS):
    ...
    modeltype="octyd_avgavg"


    #resnest50   FITNet  resnest50cbma  resnest50cbma2  resnest50next  resnest50stage  hbsp_avglinear  hbsp_avglinear  hbsp_avgavg
    modeltype="hbsp_avgavg"
    ...
    from fusion_multi_model import Build_MultiModel_ShareBackbone


 


    model = Build_MultiModel_ShareBackbone(backbone=modeltype)
    ...
    with torch.no_grad():
        ...
        for val_data in validate_loader:
            hbimages, spimages,val_labels,imgids = val_data
            ...
            #20张图片最初作为对象扔进来，方法：
            outputs = model(hbimages, spimages)
