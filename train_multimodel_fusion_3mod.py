...
from fusion_multi_model import Build_MultiModel_ShareBackbone,Build_MultiModel_ShareBackbone_3mod,Build_MultiModel_ShareBackbone_3mod_org
...
class CustomDataset_Multi(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # yd_image_list=get_random_images( self.sp_im_names[idx].split(';'),12)
        ...
        return hbimages,spimages,ydimage,self.im_labels[idx], self.im_path_head[idx]
...
def main():
    ...
    taskname='_1101_3mod_fusion_avgavg_org'
    print(taskname)
    ...
    net = Build_MultiModel_ShareBackbone_3mod_org(backbone=modeltype)
