...
# weights_path = "/vepfs/gaowh/backup/trsl/1023/_8_hbyd_fusion_avgavg/resNet50_8_hbyd_fusion_avgavg_best.pth"

# weights_path = "/vepfs/gaowh/backup/trsl/1023/_9_spyd_fusion_avgavg/resNet50_9_spyd_fusion_avgavg_best.pth"

weights_path = "/root/work2023/deep-learning-for-image-processing-master/pytorch_classification/Test5_resnet_sl/1113_hbyd_fusion_avgavg/resNet501113_hbyd_fusion_avgavg_best.pth"
...
def runpredict(LISTS):
    ...
    model = Build_MultiModel_ShareBackbone_octyd(backbone=modeltype)
